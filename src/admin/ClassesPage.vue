<template>
    ...
    <div class="row">
      ...
      <div class="col-3 text-right">
        <router-link to="/classes/new"  class="btn btn-primary"
          ><i class="fa fa-plus-circle"></i> New Class</router-link
        >
      </div>
    </div>
    <div class="row">
...
export default {
    ...
    methods: {
        deleteClass: function(id){
          classService.deleteById(id).then(user => {
    ...
    created () {
        classService.getAll().then(classes => this.classes = classes);
    }
};
</script>